...
public class AnimationComponent extends AppCompatActivity {
    ...
    private List<FrameBuffer.FrameUnit> frameBuffer;
    ...
    private void Play(boolean delay) {
        ...
        FrameBuffer.FrameUnit frame = frameBuffer.get(ietterator.GetValue());
        switch (frame.Type){
            case paint:
                FrameBuffer.PaintUnit paintUnit = frame.paint;
                StartAnimationPaint(paintUnit);
                break;
            case movePlayer:
                FrameBuffer.MotionPlayer motionPlayer = frame.frame;
                PlayAnimation(motionPlayer, delay);
        }
    }

    public void StartAnimationPaint(FrameBuffer.PaintUnit paintUnit){
    ...
    private void PlayAnimation(FrameBuffer.MotionPlayer frame, boolean isDelay) {
